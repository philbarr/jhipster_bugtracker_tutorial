  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tutorialJhipsterBugtrackerApp.ticket.home.createOrEditLabel">
            <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.home.createOrEditLabel">Create or edit a Ticket</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
