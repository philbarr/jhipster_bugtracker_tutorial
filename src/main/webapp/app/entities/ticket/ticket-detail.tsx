...
export const TicketDetail = (props: ITicketDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.detail.title">Ticket</Translate> [<b>{ticketEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="title">
              <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.title">Title</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="dueDate">
              <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.dueDate">Due Date</Translate>
            </span>
          </dt>
          <dd>
            <TextFormat value={ticketEntity.dueDate} type="date" format={APP_LOCAL_DATE_FORMAT} />
          </dd>
          <dt>
            <span id="done">
              <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.done">Done</Translate>
            </span>
          </dt>
          <dd>{ticketEntity.done ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.project">Project</Translate>
          </dt>
          ...
          <dt>
            <Translate contentKey="tutorialJhipsterBugtrackerApp.ticket.label">Label</Translate>
          </dt>
          <dd>
            {ticketEntity.labels
