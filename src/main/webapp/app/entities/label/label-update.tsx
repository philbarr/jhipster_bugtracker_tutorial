  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tutorialJhipsterBugtrackerApp.label.home.createOrEditLabel">
            <Translate contentKey="tutorialJhipsterBugtrackerApp.label.home.createOrEditLabel">Create or edit a Label</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
