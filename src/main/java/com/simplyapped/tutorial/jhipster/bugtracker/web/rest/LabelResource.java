...
import com.simplyapped.tutorial.jhipster.bugtracker.repository.LabelRepository;
...
/**
 * REST controller for managing {@link com.simplyapped.tutorial.jhipster.bugtracker.domain.Label}.
 */
@RestController
@RequestMapping("/api")
@Transactional
