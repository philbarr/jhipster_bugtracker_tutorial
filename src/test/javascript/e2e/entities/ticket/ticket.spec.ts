...
describe('Ticket e2e test', () => {
  ...
  it('should load create Ticket page', async () => {
    ...
    expect(await ticketUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /tutorialJhipsterBugtrackerApp.ticket.home.createOrEditLabel/
    );
  ...
  it('should delete last Ticket', async () => {
    ...
    expect(await ticketDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/tutorialJhipsterBugtrackerApp.ticket.delete.question/);
