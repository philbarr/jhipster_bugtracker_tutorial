...
describe('Project e2e test', () => {
  ...
  it('should load create Project page', async () => {
    ...
    expect(await projectUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /tutorialJhipsterBugtrackerApp.project.home.createOrEditLabel/
    );
  ...
  it('should delete last Project', async () => {
    ...
    expect(await projectDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/tutorialJhipsterBugtrackerApp.project.delete.question/);
